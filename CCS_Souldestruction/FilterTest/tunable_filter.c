...
{
	_biq[0] =  filters[FILTER_SELECT*BIQ_COEFF + 0] >> 1;		//b0
	_biq[1] =  filters[FILTER_SELECT*BIQ_COEFF + 1] >> 1;		//b1
	_biq[2] =  filters[FILTER_SELECT*BIQ_COEFF + 2] >> 1;		//b2

	_biq[3] =  filters[FILTER_SELECT*BIQ_COEFF + 3] >> 1;		//a0  -- this one is actually ignored.
	_biq[4] =  filters[FILTER_SELECT*BIQ_COEFF + 4] >> 1;		//a1
	_biq[5] =  filters[FILTER_SELECT*BIQ_COEFF + 5] >> 1;		//a2
}
